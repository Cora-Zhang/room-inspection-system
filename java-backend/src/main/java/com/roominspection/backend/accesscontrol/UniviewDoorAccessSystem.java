 ...
 */
@Slf4j
public class UniviewDoorAccessSystem implements DoorAccessSystem {

    private static final String PROTOCOL_NAME = "Uniview Door Access";
    ...
    public void connect(String host, int port, Map<String, Object> params) throws Exception {
        try {
            ...
            log.info("宇视门禁系统连接成功: {}:{}", host, port);
        } catch (Exception e) {
            lastError = e.getMessage();
            log.error("宇视门禁系统连接失败", e);
            throw new Exception("宇视门禁系统连接失败: " + e.getMessage());
        }
    }
    ...
    public void disconnect() {
        try {
            ...
            log.info("宇视门禁系统已断开连接");
        } catch (Exception e) {
            log.error("断开宇视门禁系统连接失败", e);
        }
    }
    ...
    private void login() throws Exception {
        // 宇视门禁登录逻辑
        sessionToken = "uniview_session_token_" + System.currentTimeMillis();
    }
    ...
    public Map<String, Object> getDoorStatus(String doorId) throws Exception {
        ...
        try {
            ...
            status.put("manufacturer", "Uniview");
            return status;
        } catch (Exception e) {
            lastError = e.getMessage();
